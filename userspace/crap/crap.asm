...
; loc     buffer : (@-4): * char
; =
; RPN'ized expression: "L353 "
; Expanded expression: "L353 "
...
section .text
; Fused expression:    "=(204) *(@-4) L353 "
	mov	eax, L353
	mov	[ebp-4], eax
; RPN'ized expression: "( 5 , buffer , L355 write ) "
; Expanded expression: " 5  (@-4) *(4)  L355  write ()12 "
...
section .text
; Fused expression:    "( 5 , *(4) (@-4) , L355 , write )12 "
	push	5
	push	dword [ebp-4]
	push	L355
	call	_write
